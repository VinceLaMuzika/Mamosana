...
function productImageHTML(p){
  if(p.img){
    return `<img src="${p.img}" alt="${p.name}" style="width:100%;height:100%;object-fit:cover;" 
      onerror="this.outerHTML='<div style=width:100%;height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:10px;background:var(--green-wash)><i class=fas fa-leaf style=font-size:2.5rem;color:var(--green-mid);opacity:0.5></i><span style=font-size:0.7rem;color:var(--text-light);letter-spacing:0.05em>COMING SOON</span></div>'">`;
  }
